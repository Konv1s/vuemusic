<template>
    <div class="text-white text-center font-bold p-5 mb-4" v-if="reg_alert_variant"
        ...
        <div class="mb-3">
            ...
            <vee-field name="password" :bails="false" v-slot="{field,errors}">
                <input type="password" class="block w-full py-1.5 px-3 text-gray-800 border
                                 border-gray-300 transition duration-500 focus:outline-none focus:border-black rounded"
    ...
    data() {
      return {
        schema: {
          ...
          country: 'required|county_excluded:Germany',
          tos: 'tos',
        },
        userData: {
          county: 'USA'
